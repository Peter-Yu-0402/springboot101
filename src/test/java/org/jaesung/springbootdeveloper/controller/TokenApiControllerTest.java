...
import org.jaesung.springbootdeveloper.config.jwt.JwtFactory;
import org.jaesung.springbootdeveloper.config.jwt.JwtProperties;
...
class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        // given
        // 테스트 유저 생성하고, jjwt 라이브러리를 이용해 리프레시 토큰 만들어 데이터베이스에 저장한다.
        ...
        // then
        // 응답 코드가 201 CREATED인지 확인하고 응답으로 온 액세스 토큰이 비어있지 않은지 확인하다.
        resultActions
